...
public class TrafficDaoImpl implements TrafficDao {
    ...
    public boolean isExists(final Traffic traffic) throws DaoException {
        ...
        try (final PreparedStatement statement = connection
                .prepareStatement(EXISTS_BY_SUBSCRIPTION_ID_QUERY)) {
            statement.setInt(1, traffic.getSubscriptionId());
            statement.setInt(2, traffic.getValue());
            statement.setDate(3,
                    java.sql.Date.valueOf(traffic.getDate()));
            ...
            throw new DaoException(
                    rb.getString("traffic.exist.exception"), e);
        }
    }
    ...
    public List<Traffic> findAndSortByDate() throws DaoException {
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("traffic.find.or.sort.by.date.exception"));
        }
    }
    ...
    public List<Traffic> findAndFilterBySubscriptionId(final Integer subscriptionId) throws DaoException {
        ...
        try (final PreparedStatement statement = connection
            ...
            throw new DaoException(
                    rb.getString("traffic.find.or.filter.by.subscription"
                            + ".id.exception"));
        }
    }
    ...
    public List<Traffic> findAndFilterAndSortOffset(
        ...
        try (final PreparedStatement statement = connection
            ...
            throw new DaoException(
                    rb.getString("traffic.find.or.filter.by.subscription"
                            + ".id.or.sort.by.date.exception"));
        }
    }

    @Override
    public Traffic findOneById(final Integer id) {

        throw new UnsupportedOperationException(
                rb.getString("traffic.find.one.by.id.unsupported"
                        + ".exception"));
    }
    ...
    public void add(final Traffic traffic) throws DaoException {
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("traffic.add.exception"), e);
        }
    }
    ...
    public void update(final Traffic traffic) {
        throw new UnsupportedOperationException(
                rb.getString("traffic.update.unsupported.exception"));
    }
    ...
    public void delete(final Integer subscriptionId) throws DaoException {
        ...
        try (final PreparedStatement statement = connection
            ...
            throw new DaoException(
                    rb.getString("traffic.delete.exception"), e);
        }
    }


    private Traffic buildTraffic(final ResultSet resultSet)
            throws SQLException {
