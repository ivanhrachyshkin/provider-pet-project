...
public class SubscriptionDaoImpl implements SubscriptionDao {
    ...
    String FIND_ONE_SUBSCRIPTION_BY_ACCOUNT_AND_TARIFF_ID_QUERY =
            "SELECT id, account_id, tariff_id "
                    + "FROM subscriptions "
                    + "WHERE account_id = ? and tariff_id = ?";
    ...
    public boolean isExistById(final Integer id) throws DaoException {
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("subscription.exist.by.id.exception"), e);
        }
    }
    ...
    public boolean isExistByTariffId(final Integer tariffId)
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("subscription.exist.by.tariff.id"
                            + ".exception"), e);
        }
    }

    @Override
    public boolean isExistByAccountAndTariffId(final Integer accountId,
                                               final Integer tariffId)
            throws DaoException {

        try (final PreparedStatement statement = connection
                .prepareStatement(EXISTS_BY_ACCOUNT_AND_TARIFF_ID_QUERY)) {
            ...
            throw new DaoException(
                    rb.getString("subscription.exist.by.account.id.and"
                            + ".tariff.id.exception"), e);
        }
    }
    ...
    public List<Subscription> find() throws DaoException {
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("subscription.find.exception"));
        }
    }
    ...
    public List<Subscription> findAndFilterByAccountId(final Integer accountId)
        ...
        try (final PreparedStatement statement = connection
                .prepareStatement(FIND_AND_FILTER_BY_ACCOUNT_ID_QUERY)) {
            statement.setInt(1, accountId);
            ...
            throw new DaoException(
                    rb.getString("subscription.find.or.filter.by.account"
                            + ".id.exception"));
        }
    }
    ...
    public Subscription findOneById(final Integer id) throws DaoException {
        ...
        try (final PreparedStatement statement = connection
                .prepareStatement(FIND_ONE_SUBSCRIPTION_QUERY_BY_ID)) {
            statement.setInt(1, id);
            ...
            throw new DaoException(
                    rb.getString("subscription.find.one.by"
                            + ".id.exception"), e);
        }
    }
    ...
    public Subscription findOneByAccountIdAndTariffId(final Integer accountId,
        ...
        try (final PreparedStatement statement = connection
                .prepareStatement(
                        FIND_ONE_SUBSCRIPTION_BY_ACCOUNT_AND_TARIFF_ID_QUERY)) {
            statement.setInt(1, accountId);
            statement.setInt(2, tariffId);
            ...
            throw new DaoException(
                    rb.getString("subscription.find.one.by.id"
                            + ".exception"), e);
        }
    }
    ...
    public void add(final Subscription subscription) throws DaoException {
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("subscription.add.exception"), e);
        }
    }
    ...
    public void update(final Subscription subscription) throws DaoException {
        throw new UnsupportedOperationException(
                rb.getString("subscription.update.unsupported.exception"));
    }
    ...
    public void delete(final Integer id) throws DaoException {
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("subscription.delete.exception"), e);
        }
    }

    @Override
    public void deleteByAccountIdAndTariffId(final Integer subscriptionId)
            throws DaoException {
        ...
        try (final PreparedStatement statement =
            ...
            throw new DaoException(
                    rb.getString("subscription.delete.by.account.id.and"
                            + ".tariff.id.exception"), e);
        }
    }

    private Subscription buildSubscription(final ResultSet resultSet)
            throws SQLException {
