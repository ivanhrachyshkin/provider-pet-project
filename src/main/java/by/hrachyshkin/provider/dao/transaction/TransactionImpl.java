...
import by.hrachyshkin.provider.dao.entity_dao.account_dao.AccountDaoImpl;
import by.hrachyshkin.provider.dao.entity_dao.bill_dao.BillDaoImpl;
import by.hrachyshkin.provider.dao.entity_dao.discount_dao.DiscountDaoImpl;
import by.hrachyshkin.provider.dao.entity_dao.promotion_dao.PromotionDaoImpl;
import by.hrachyshkin.provider.dao.entity_dao.subscription_dao.SubscriptionDaoImpl;
import by.hrachyshkin.provider.dao.entity_dao.tariff_dao.TariffDaoImpl;
import by.hrachyshkin.provider.dao.entity_dao.traffic_dao.TrafficDaoImpl;
