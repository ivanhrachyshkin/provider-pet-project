...
public class TrafficServiceImpl implements TrafficService {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(TrafficServiceImpl.class);
    ...
    public List<Traffic> findAndFilterAndSortOffset(final Integer subscriptionId, final int offset) throws ServiceException, TransactionException {
        ...
        try {
            ...
            final TrafficDao trafficDao = transactionImpl.createDao(DaoKeys.TRAFFIC_DAO);
            final List<Traffic> traffics = trafficDao.findAndFilterAndSortOffset(subscriptionId, offset);
    ...
    public Traffic findOneById(final Integer id) throws ServiceException {
        LOGGER.error(rb.getString("traffic.find.one.by.id.unsupported.exception"));
    ...
    public void add(final Traffic traffic) throws ServiceException, TransactionException {
        ...
        try {
            ...
            if (traffic.getValue() == null
                ...
                LOGGER.error(rb.getString("traffic.add.empty.input.exception"));
                transactionImpl.rollback();
            ...
            if (traffic.getValue() < 0) {
                LOGGER.error(rb.getString("traffic.add.negative.exception"));
                transactionImpl.rollback();
